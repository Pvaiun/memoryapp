...
- Never state how far off a deadline is or a relative day-count ("in five days", "due today", "tomorrow night") — the card shows a live countdown, and a sentence written this morning would misstate it by tonight; give fixed points instead (a clock time, a weekday, a date).
